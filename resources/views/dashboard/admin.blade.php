    ...
    <div class="py-8">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
                <!-- Total Cabang -->
                <div class="bg-white rounded-2xl p-5 border border-[#EBE5DF] shadow-sm hover:shadow-md transition-all">
                    ...
                    <p class="text-xs text-[#6E675F] mt-1">Kantor operasional aktif</p>
                </div>
                ...
                <div class="bg-white rounded-2xl p-5 border border-[#EBE5DF] shadow-sm hover:shadow-md transition-all">
                    ...
                    <p class="text-xs text-[#6E675F] mt-1">Pengelola cabang</p>
                </div>
                ...
                <div class="bg-white rounded-2xl p-5 border border-[#EBE5DF] shadow-sm hover:shadow-md transition-all">
                    ...
                    <p class="text-xs text-[#6E675F] mt-1">Tenaga pengajar</p>
                </div>
            ...
            <div class="bg-white rounded-3xl p-6 sm:p-8 border border-[#EBE5DF] shadow-sm">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    <div class="p-5 rounded-2xl bg-[#FFF7ED] border border-[#FED7AA] flex flex-col justify-between">
                        <div>
                            <div class="w-10 h-10 rounded-xl bg-[#FF6B00] text-white flex items-center justify-center mb-3">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"/></svg>
                            </div>
                            <h4 class="font-montserrat font-bold text-base text-[#1E1B18]">CRUD Akun Admin Cabang</h4>
                            <p class="text-xs text-[#6E675F] mt-1">Kelola data login admin, penugasan wilayah cabang, status aktif, dan reset akses.</p>
                        </div>
                        <span class="inline-block mt-4 text-xs font-bold text-[#EA580C] font-montserrat">PRD 1.1 • Siap Dikembangkan di Fase 1 &rarr;</span>
                    </div>

                    <div class="p-5 rounded-2xl bg-[#FEF2F2] border border-[#FECACA] flex flex-col justify-between">
                        <div>
                            <div class="w-10 h-10 rounded-xl bg-[#DC2626] text-white flex items-center justify-center mb-3">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
                            </div>
                            <h4 class="font-montserrat font-bold text-base text-[#1E1B18]">Log Aktivitas Admin</h4>
                        ...
                        <span class="inline-block mt-4 text-xs font-bold text-[#DC2626] font-montserrat">PRD 1.2 • Siap Dikembangkan di Fase 1 &rarr;</span>
                    </div>

                    <div class="p-5 rounded-2xl bg-[#FAF8F5] border border-[#EBE5DF] flex flex-col justify-between">
                        <div>
                            <div class="w-10 h-10 rounded-xl bg-[#1E1B18] text-white flex items-center justify-center mb-3">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"/></svg>
                            </div>
                            <h4 class="font-montserrat font-bold text-base text-[#1E1B18]">Master Data Cabang</h4>
                            <p class="text-xs text-[#6E675F] mt-1">Tambah dan kelola kantor cabang fisik di seluruh Indonesia.</p>
                        </div>
                        <span class="inline-block mt-4 text-xs font-bold text-[#6E675F] font-montserrat">Master Cabang &rarr;</span>
                    </div>
                </div>
            </div>
