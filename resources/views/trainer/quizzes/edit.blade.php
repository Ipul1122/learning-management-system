    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h1 class="text-2xl font-extrabold text-[#1E1B18] tracking-tight font-montserrat">Edit Konfigurasi Kuis</h1>
                    <p class="text-xs text-[#6E675F] mt-0.5 font-quicksand">Ubah pengaturan evaluasi atau susunan butir soal pada kuis ini.</p>
                </div>
            </div>
        </div>
    </x-slot>
                ...
                <div class="space-y-6">
                    <div class="bg-white border border-[#EBE5DF] rounded-2xl p-5 sm:p-6 space-y-4 shadow-sm">
                        ...
                        <div>
                            ...
                            <input type="text" name="title" value="{{ old('title', $quiz->title) }}" required placeholder="Contoh: Kuis Evaluasi Modul 1 - Fundamental"
                        ...
                        <div>
                            ...
                            <textarea name="description" rows="3" placeholder="Petunjuk pengerjaan untuk peserta..."
                                      class="w-full text-xs rounded-xl bg-white border border-[#EBE5DF] text-[#1E1B18] placeholder-[#A8A29E] focus:ring-2 focus:ring-[#FF6B00] font-quicksand">{{ old('description', $quiz->description) }}</textarea>
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-3 pt-2">
                            ...
                            <div>
                                ...
                                <input type="number" step="1" min="0" max="100" name="passing_grade" value="{{ old('passing_grade', (int) $quiz->passing_grade) }}" required
                                       class="w-full text-xs rounded-xl bg-white border border-[#EBE5DF] text-[#1E1B18] focus:ring-2 focus:ring-[#FF6B00] font-mono">
                            </div>
                        </div>
                        ...
                        <!-- Active State -->
                        <div class="pt-2 border-t border-[#EBE5DF]">
                            <label class="relative flex items-center cursor-pointer">
                                <input type="checkbox" name="is_active" value="1" {{ old('is_active', $quiz->is_active) ? 'checked' : '' }} class="sr-only peer">
                                <div class="w-9 h-5 bg-[#EBE5DF] peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-[#EBE5DF] after:border after:rounded-full after:h-4 after:w-4 after:transition-all peer-checked:bg-emerald-600"></div>
                                <span class="ml-2 text-xs font-bold text-[#1E1B18] font-montserrat">Publikasikan Kuis (Aktif)</span>
                            </label>
                            <p class="text-[10px] text-[#A8A29E] mt-1 font-quicksand">Jika dinonaktifkan, peserta tidak dapat melihat atau mengerjakan kuis ini.</p>
                        </div>
                    ...
                    <div class="bg-white border border-[#EBE5DF] rounded-2xl p-5 sm:p-6 space-y-4 shadow-sm">
                        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 pb-3 border-b border-[#EBE5DF]">
                            <div>
                                ...
                                <p class="text-xs text-[#6E675F] mt-0.5 font-quicksand">Centang butir soal yang diikutsertakan dalam paket kuis ini.</p>
                            </div>
