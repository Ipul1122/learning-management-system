    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h1 class="text-2xl font-extrabold text-white tracking-tight">Rancang Paket Kuis Baru</h1>
                    <p class="text-xs text-slate-400 mt-0.5">Tentukan parameter ujian dan pilih butir soal dari Bank Soal Cabang {{ $branch->name }}.</p>
                </div>
            </div>
        </div>
    </x-slot>
                    ...
                    <div class="bg-slate-900/60 border border-slate-800/80 rounded-2xl p-5 space-y-4">
                        ...
                        <div>
                            ...
                            <textarea name="description" rows="3" placeholder="Petunjuk pengerjaan untuk peserta..."
                                      class="w-full text-xs rounded-xl bg-slate-800/80 border border-slate-700 text-white placeholder-slate-500 focus:ring-2 focus:ring-orange-500">{{ old('description') }}</textarea>
                        </div>
                    ...
                    <div class="bg-slate-900/60 border border-slate-800/80 rounded-2xl p-5 space-y-4">
                        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 pb-3 border-b border-slate-800">
                            <div>
                                ...
                                <p class="text-xs text-slate-400 mt-0.5">Centang butir soal yang ingin diikutsertakan dalam paket kuis ini.</p>
                            </div>
