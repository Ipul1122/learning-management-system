<header class="h-16 bg-white border-b border-[#EBE5DF] sticky top-0 z-30 flex items-center justify-between px-4 sm:px-6 lg:px-8">
    ...
    <div class="flex items-center gap-3">
        ...
        <div class="hidden sm:flex items-center gap-2 text-xs font-montserrat">
            <span class="text-[#6E675F]">Portal Instruktur</span>
    ...
    <div class="flex items-center gap-3">
        ...
        <span class="px-2.5 py-1 rounded-full text-xs font-bold font-montserrat bg-[#FFF7ED] text-[#FF6B00] border border-[#FED7AA] hidden sm:inline-flex items-center gap-1.5">
            <span class="w-1.5 h-1.5 rounded-full bg-[#FF6B00]"></span>
            <span>Trainer / Pengajar</span>
        </span>
