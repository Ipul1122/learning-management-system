<nav x-data="{ open: false }" class="bg-white border-b border-[#EBE5DF]">
        ...
        <div class="flex justify-between h-16">
            <div class="flex items-center">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" class="flex items-center gap-2.5">
                        ...
                        <span class="font-montserrat font-extrabold text-base tracking-tight text-[#1E1B18] hidden sm:inline">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                @php
                    ...
                    $badgeConfig = match($roleName) {
                        'super-admin' => ['label' => 'Super Admin', 'bg' => 'bg-[#FFF7ED]', 'text' => 'text-[#EA580C]', 'border' => 'border-[#FED7AA]'],
                        'admin-cabang' => ['label' => 'Admin Cabang', 'bg' => 'bg-[#FEF2F2]', 'text' => 'text-[#DC2626]', 'border' => 'border-[#FECACA]'],
                        'trainer' => ['label' => 'Trainer', 'bg' => 'bg-[#FFF7ED]', 'text' => 'text-[#FF6B00]', 'border' => 'border-[#FED7AA]'],
                        'peserta' => ['label' => 'Peserta', 'bg' => 'bg-[#ECFDF5]', 'text' => 'text-[#10B981]', 'border' => 'border-[#A7F3D0]'],
                        default => ['label' => $roleName, 'bg' => 'bg-gray-100', 'text' => 'text-gray-700', 'border' => 'border-gray-200']
                    };
                @endphp
                <span class="me-3 px-2.5 py-1 rounded-full text-xs font-bold font-montserrat {{ $badgeConfig['bg'] }} {{ $badgeConfig['text'] }} border {{ $badgeConfig['border'] }}">
                    {{ $badgeConfig['label'] }}
                </span>

                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center px-3 py-2 border border-[#EBE5DF] text-sm leading-4 font-semibold rounded-xl text-[#1E1B18] bg-white hover:bg-[#FAF8F5] focus:outline-none transition ease-in-out duration-150">
                            <div>{{ Auth::user()->name }}</div>

                            <div class="ms-1 text-[#6E675F]">
