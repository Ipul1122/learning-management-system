            ...
            <div x-show="isOpen"
                ...
                <div @click.away="isOpen = false"
                    ...
                    <div class="p-5 sm:p-6 overflow-y-auto space-y-5">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 bg-[#FAF8F5] p-3.5 sm:p-4 rounded-2xl border border-[#EBE5DF]">
                            ...
                            <div class="space-y-0.5">
                                ...
                                <div class="text-[11px] text-[#6E675F] font-quicksand" x-text="currentLog.branch?.name ? 'Cabang: ' + currentLog.branch.name : 'Pusat / Global'"></div>
                            </div>
                            <div class="space-y-0.5">
                        ...
                        <div x-show="activeTab === 'human'" class="space-y-4">
                            <!-- SKENARIO UPDATE: Ada perubahan field -->
                            <template x-if="currentLog.action === 'UPDATE'">
                                <div class="space-y-3">
                                    ...
                                    <div class="p-3.5 rounded-2xl bg-[#FFF7ED] border border-[#FF6B00]/30 flex items-start gap-3">
                                        ...
                                        <div class="text-xs font-quicksand text-[#1E1B18]">
                                            <template x-if="diff.changes.length > 0">
                                                <div>
                                                    Operasi pembaruan ini mengubah <strong><span x-text="diff.changes.length"></span> atribut</strong> pada entitas <strong x-text="currentLog.target_entity_label || formatEntity(currentLog.target_entity)"></strong>. Rincian nilai sebelum dan sesudah perubahan tertera di bawah:
                                                </div>
                                            </template>
                                            <template x-if="diff.changes.length === 0">
                                                <div>
                                    ...
                                    <!-- Bagian Unchanged Properties (Collapsible) -->
                            ...
                            <!-- SKENARIO CREATE: Pembuatan objek baru -->
                                ...
                                <div class="space-y-3">
                                    <div class="p-3.5 rounded-2xl bg-[#ECFDF5] border border-[#A7F3D0] flex items-start gap-3">
                                        ...
                                        <div class="text-xs font-quicksand text-[#065F46]">
                                            Data baru untuk entitas <strong x-text="currentLog.target_entity_label || formatEntity(currentLog.target_entity)"></strong> berhasil didaftarkan dengan atribut awal sebagai berikut:
                                        </div>
                                    </div>
                            ...
                            <!-- SKENARIO DELETE: Penghapusan objek -->
                                ...
                                <div class="space-y-3">
                                    <div class="p-3.5 rounded-2xl bg-[#FEF2F2] border border-[#FECACA] flex items-start gap-3">
                                        ...
                                        <div class="text-xs font-quicksand text-[#991B1B]">
                                            Data entitas <strong x-text="currentLog.target_entity_label || formatEntity(currentLog.target_entity)"></strong> telah dihapus dari database. Rekaman atribut sebelum dihapus adalah:
                                        </div>
                                    </div>
                        ...
                        <div x-show="activeTab === 'json'" class="space-y-4">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <!-- Nilai Sebelumnya (Old Properties) -->
                                <div>
                    ...
                    <div class="p-4 bg-[#FAF8F5] border-t border-[#EBE5DF] flex items-center justify-between">
                        ...
                        <button type="button"
                                @click="isOpen = false"
                                class="px-5 py-2.5 rounded-xl font-montserrat font-bold text-xs bg-[#1E1B18] text-white hover:bg-[#322E2B] transition shadow-xs">
                            Tutup Inspeksi
                        </button>
                    </div>
                </div>
